...
const STORAGE_KEY = "mylittleskies_vehicle_progress";
const NAME_KEY = "mylittleskies_player_name";
const UNLOCK_ACK_KEY = "mylittleskies_unlocks_ack";
const PLAYER_WORLD_STATE_KEY = "mylittleskies_player_world_state_v1";
/** Campsite bookmark; cleared with `clearAll` for a full local reset. */
const CAMPSITE_KEY = "mylittleskies_campsite_v2";
const LEGACY_CAMPSITE_KEY = "mylittleskies_campsite";
